...
"""autogenerated by genpy from navya_control/DriveActionResult.msg. Do not edit."""
import sys
...
class DriveActionResult(genpy.Message):
  _md5sum = "1bcef445bb6d1a7b75e66ef3149f1058"
  _type = "navya_control/DriveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','navya_control/DriveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DriveActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = navya_control.msg.DriveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = navya_control.msg.DriveResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.result.total_dishes_cleaned))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.total_dishes_cleaned,) = _get_struct_d().unpack(str[start:end])
      return self
