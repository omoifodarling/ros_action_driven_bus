...
"""autogenerated by genpy from navya_control/DriveActionFeedback.msg. Do not edit."""
import sys
...
class DriveActionFeedback(genpy.Message):
  _md5sum = "25bfb21ced59f4f9490772d56f6961f4"
  _type = "navya_control/DriveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','navya_control/DriveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DriveActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = navya_control.msg.DriveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = navya_control.msg.DriveFeedback()
