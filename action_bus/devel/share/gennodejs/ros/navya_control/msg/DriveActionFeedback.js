...
class DriveActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new DriveFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DriveFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DriveActionFeedback(null);
    ...
    data.feedback = DriveFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DriveActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = DriveFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new DriveFeedback()
    }
...
module.exports = DriveActionFeedback;
